                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @foreach($assignments as $assignment)
                            @php
                                $submission = \App\Models\Submission::get()->where('assignment_id', $assignment->id)->where('student_id', Auth::user()->id)->first();
                            @endphp
                            <div class="card post mt-3">
                                <div class="card-body">
                                    <p class="card-text">{{$assignment->title}} @if($submission) <span class="badge badge-success">Submitted</span> @else <span class="badge badge-danger">Due</span> @endif</p>
                                    <p class="card-text">
